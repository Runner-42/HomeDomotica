...
echo "Sending Set Loglevel Request INFO event on $active_environment environment"
python3 $path_to_source_files/send_set_loglevel_req.py IQ_RPI_LIGHTSIMULATOR_$pi_reference INFO
