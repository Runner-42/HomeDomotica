...
python3 $path_to_source_files/send_stop.py IQ_RPI_INPUTBUTTON_$pi_reference
echo "Stopping 'outputrelay' process"
python3 $path_to_source_files/send_stop.py IQ_RPI_OUTPUTRELAY_$pi_reference
echo "Stopping 'outputlights' process"
python3 $path_to_source_files/send_stop.py IQ_RPI_OUTPUTLIGHTS_$pi_reference
echo "Stopping 'outputdimmer' process"
python3 $path_to_source_files/send_stop.py IQ_RPI_OUTPUTDIMMER_$pi_reference
